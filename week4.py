...
simpleWalls = [(0, False, 0, 168), (168, True, 0, 84), (84, False, 126, 168), (210, True, 84, 168), (168, False, 84, 210), (84, True, 168, 210), (210, False, 0, 84), (0, True, 0, 210)]  # noqa
...
def resetParticleCloud():
    ...
    particleCloud = [(start_x + random.gauss(0, 3), start_y + random.gauss(0, 3), start_theta, 0.01) for j in range(NUMBER_OF_PARTICLES)]  # noqa
...
#assumes 0 < theta < 2 * pi
    ...
    for i in range(len(simpleWalls)):
        ...
        if horizontal:
            ...
            if theta == math.pi / 2 or theta == 1.5 * math.pi:
                continue
            x2 = const
